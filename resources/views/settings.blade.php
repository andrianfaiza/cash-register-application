...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <form method="POST" action="{{ route('settings.update') }}" class="space-y-6"> 
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            <h2 class="text-xs font-bold text-slate-800 tracking-wider uppercase mb-5">Bahasa &amp; Format</h2>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label class="block text-xs font-semibold text-slate-500 tracking-wide mb-1.5">BAHASA</label>
                    <select name="bahasa" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-500 tracking-wide mb-1.5">MATA UANG</label>
                    <select name="mata_uang" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-500 tracking-wide mb-1.5">FORMAT TANGGAL</label>
                    <select name="format_tanggal" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition">
        ...
        {{-- Mode Tampilan --}}
        <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            <h2 class="text-xs font-bold text-slate-800 tracking-wider uppercase mb-5">Mode Tampilan</h2>
            ...
            <div class="grid grid-cols-2 gap-4 max-w-md">
                ...
                <label class="cursor-pointer">
                    ...
                    <div class="border-2 border-slate-200 peer-checked:border-slate-900 rounded-xl p-4 bg-white transition hover:border-slate-300">
                        ...
                        <p class="text-sm font-semibold text-slate-800 text-center">Light Mode</p>
                    </div>
                </label>
                ...
                <label class="cursor-pointer">
                    ...
                    <div class="border-2 border-slate-200 peer-checked:border-slate-900 rounded-xl p-4 bg-white transition hover:border-slate-300">
                        ...
                        <p class="text-sm font-semibold text-slate-800 text-center">Dark Mode</p>
                    </div>
                </label>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            <h2 class="text-xs font-bold text-slate-800 tracking-wider uppercase mb-5">Pengaturan Notifikasi</h2>

            <!-- Notifikasi via Email -->
            <div class="flex items-center justify-between py-3 border-b border-slate-100">
                <div>
                    <p class="text-sm font-semibold text-slate-700">Notifikasi via Email</p>
                    <p class="text-xs text-slate-400 mt-0.5">Kirim email saat ada pengajuan transaksi baru yang perlu diverifikasi.</p>
                </div>
            ...
            <div class="flex items-center justify-between py-3">
                <div>
                    <p class="text-sm font-semibold text-slate-700">Notifikasi Sistem / Browser</p>
                    <p class="text-xs text-slate-400 mt-0.5">Tampilkan peringatan browser untuk saldo minim atau anggaran mendekati batas.</p>
                </div>
        ...
        <div class="flex justify-end pt-2">
            <button type="submit" class="bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold px-6 py-2.5 rounded-lg transition shadow-sm">
                Simpan Preferensi
            </button>
        </div>
    </form>
