...
<div id="formModal" class="fixed inset-0 z-50 flex items-center justify-center hidden px-4" role="dialog" aria-modal="true">
    ...
    {{-- Modal Box --}}
    <div id="modalBox" class="modal-box relative bg-white rounded-2xl shadow-xl w-full max-w-md z-10 overflow-hidden transform scale-95 opacity-0">
        ...
        <form id="transaksiForm" method="POST" action="{{ route('transaksi.store') }}" enctype="multipart/form-data" onsubmit="return handleTransaksiSubmit(event)">
            ...
            <div class="max-h-[75vh] overflow-y-auto px-6 py-6 space-y-5">
                ...
                {{-- Info banner --}}
                <div class="flex items-start gap-2 bg-slate-50 border border-slate-100 rounded-lg px-4 py-3">
                    ...
                    <p class="text-sm text-slate-500">Input detail transaksi kas masuk atau kas keluar.</p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-1 bg-slate-100 rounded-lg p-1">
                    <button type="button" id="tabKeluar" onclick="setTipe('keluar')"
                        class="flex items-center justify-center gap-2 py-2 rounded-md text-sm font-semibold transition-colors bg-white shadow text-slate-800">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="date" name="tanggal" value="{{ now()->format('Y-m-d') }}"
                                class="w-full bg-slate-50 border border-slate-200 rounded-lg pl-3 pr-9 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="kategori" id="inputKategori" required class="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-sm text-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <select name="proyek_id" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="grid grid-cols-2 gap-4 items-start">
                    <div>
                        ...
                        <select name="rekening_id" class="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <label class="flex-1 flex flex-col items-center justify-center gap-1 border-2 border-dashed border-slate-200 rounded-lg py-3 cursor-pointer hover:bg-slate-50">
                            ...
                            <div class="w-11 h-11 shrink-0 flex items-center justify-center border border-slate-200 rounded-lg bg-slate-50">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-t border-slate-100">
                <button type="button" onclick="closeModal()" class="text-sm font-semibold text-slate-500 hover:text-slate-700">
                    Batal
                </button>

                <label class="flex items-center gap-2 cursor-pointer select-none">
                    <span class="text-sm font-medium text-slate-600">Verifikasi Langsung</span>
